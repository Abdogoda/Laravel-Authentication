# Laravel Authentication - **Video 06: Authentication With Github**
![thumbnail](images/thumbnail.png)  

## Overview 🌟

In this video, we focus on the **Authentication With Github** process for a Laravel application. Specifically, we implement:

- **Login With Github** 🔒  
- **Register With Github** 👤  

The goal is to ensure that users can login and register with their Github accounts to provide more realism to your application.

🎥 **Watch the full video here:** [06: Authentication With Github - Laravel Authentication](https://youtu.be/FtqXX3yrJwk)

---

## UI Design 🎨

Here are the designs related to the **Authentication With Github**:
...
Here is the folder structure for the relevant parts of the **Authentication With Github** process:
...
The **GithubAuthController** handles the redirection to Github service in order to login to Github or choose an account to perform authentication with. When the user click on *Authentication with Github*, it redirect him to the Github service to choose his account then it return back to the application as a *CALLBACK* to verify this account in order to Login or Create a new account for this user account using ***firstOrCreate*** method.
...
The `services.php` used to register the configurations related to the github service in order to use it in the application.
...
- **Github Authentication Flow**: Login or Register functionality.  
...
1. Clone the repository:  
   ...
   cd Laravel-Authentication/06_auth_with_github
   ```
...
3. Set up configurations:  
   ...
   cp .env.example .env
   ```
   Add the github service configurations in the *.env* file:
   ```bash
    GITHUB_CLIENT_ID=
...
As we continue our Socialite authentication series, this video covers Authentication with GitHub. In the next installment, we will explore **Authentication with Facebook** to further expand our social login options.
